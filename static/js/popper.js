...
! function (e, t) {
    ...
    function W(e) {
        ...
        e = void 0 === (e = (l = e).x) ? 0 : e, l = void 0 === (l = l.y) ? 0 : l;
        ...
        return r = Object.assign({
            position: f
        }, p && F), c ? Object.assign(Object.assign({}, r), {}, ((d = {})[h] = a ? "0" : "", d[m] = u ? "0" : "", d.transform = 2 > (v.devicePixelRatio || 1) ? "translate(" + e + "px, " + l + "px)" : "translate3d(" + e + "px, " + l + "px, 0)", d)) : Object.assign(Object.assign({}, r), {}, ((t = {})[h] = a ? l + "px" : "", t[m] = u ? e + "px" : "", t.transform = "", t))
    }
    ...
    var T = ["top", "bottom", "right", "left"],
        ...
        te = B({
            defaultModifiers: [_, U, X, Y]
        }),
        ne = [_, U, X, Y, G, Q, Z, $, ee],
        re = B({
            defaultModifiers: ne
        });
    e.applyStyles = Y, e.arrow = $, e.computeStyles = X, e.createPopper = re, e.createPopperLite = te, e.defaultModifiers = ne, e.detectOverflow = L, e.eventListeners = _, e.flip = Q, e.hide = ee, e.offset = G, e.popperGenerator = B, e.popperOffsets = U, e.preventOverflow = Z, Object.defineProperty(e, "__esModule", {
        value: !0
    })
}));
